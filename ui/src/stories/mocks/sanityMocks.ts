...
export const mockBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Dive deep into advanced TypeScript patterns that will make your React applications more robust and maintainable. Explore utility types, conditional types, and more.",
  ...
  },
  {
    ...
    excerpt: "Master the art of creating reusable, themeable UI components with Material-UI. Learn best practices for component composition and theming.",
