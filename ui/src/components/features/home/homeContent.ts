...
/** Work-related CTAs land on the experience page until the dedicated /work page ships (Phase 4). */
export const WORK_HREF = '/experience';
export const WRITING_HREF = '/blog';
 ...
 * (`config/socialLinks.ts`) and mapped to this section's `{ name, href }`
 * shape. Only the wired, verified URLs ship — X / YouTube are an open data gap
 * (brief §"Open data gaps"); placeholdered, not invented.
 */
