...
export default function HomeContentSection({ module }: HomeContentSectionProps) {
    ...
    const imageUrl = imageBuilder && 'width' in imageBuilder
        ? (imageBuilder as { width: (w: number) => { quality: (q: number) => { url: () => string } } }).width(800).quality(90).url()
            ...
            <Container maxWidth="lg">
                ...
                >
                    ...
                    <Box sx={{ flex: 1, maxWidth: isFullWidth ? '800px' : 'none' }}>
                        ...
                        {module.cta && (
                            <Button
                                variant={module.cta.style === 'primary' ? 'contained' : module.cta.style === 'secondary' ? 'outlined' : 'text'}
