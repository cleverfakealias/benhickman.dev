...
describe('About', () => {
  ...
  test('renders about page subtitle', () => {
    renderWithTheme(<About />);
    expect(
      screen.getByText('Passionate software engineer dedicated to building impactful solutions')
    ).toBeInTheDocument();
  });
  ...
  test('renders introduction text', () => {
    renderWithTheme(<About />);
    expect(
      screen.getByText('Hello, I’m Ben — the developer behind Zengineer Cloud Development.')
    ).toBeInTheDocument();
  });
